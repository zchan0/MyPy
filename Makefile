...
LEXFLAGS = -Wno-unused -Wno-deprecated -Wno-sign-compare -Wno-deprecated-register

OBJS = main.o parse.tab.o lex.yy.o ast.o tableManager.o symbolTable.o poolOfNodes.o
